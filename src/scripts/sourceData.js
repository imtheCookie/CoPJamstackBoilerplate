...
const client = contentful.createClient({
    space: 'eca3u2pcj37h', // Insert Contentful Space ID
    accessToken: 'boVIshM9hnhAFf4GdD3qkLfrzbdh1f4e091fmu_lhjE' // Insert Contentful Content Delivery API access token
});
